...
class MAA2C(Agent):
    ...
    def train(self):
        ...
        for agent_id in range(self.n_agents):
            ...
            q_values = self.critics[agent_id](next_states_var[:,agent_id,:], to_tensor_var(self.actors[agent_id](next_states_var[:,agent_id,:]), self.use_cuda).view(-1, self.n_agents, self.action_dim))
